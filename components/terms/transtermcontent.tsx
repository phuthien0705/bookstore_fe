...
const TransTermContent = () => {
    return (
        <>
            ...
            <Typography variant="h4" sx={{ display: 'flex', justifyContent: 'center', paddingLeft: 2, paddingRight: 2 }}>
                Áp dụng cho toàn bộ đơn hàng của Quý Khách tại Boxo.com
            </Typography>
            <Typography sx={{ p: 2 }}>
                Boxo.com cung cấp dịch vụ giao hàng toàn quốc, gửi hàng tận nơi đến địa chỉ cung cấp của Quý khách. Thời gian giao hàng dự kiến phụ thuộc vào kho có hàng và địa chỉ nhận hàng của Quý khách.
            </Typography>
            <Typography sx={{ paddingLeft: 2, paddingRight: 2, paddingBottom: 2 }}>
                 Với đa phần đơn hàng, Boxo.com cần vài giờ làm việc để kiểm tra thông tin và đóng gói hàng. Nếu các sản phẩm đều có sẵn hàng, Boxo.com sẽ nhanh chóng bàn giao cho đối tác vận chuyển. Nếu đơn hàng có sản phẩm sắp phát hành, Boxo.com sẽ ưu tiên giao những sản phẩm có hàng trước cho Quý khách hàng.
            </Typography>
