...
const SubmitCart = ({ setCurrentIndex }) => {
    return (
        <Stack sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', rowGap: 2 }}>
            <Box>
                <ButtonBase sx={{ display: 'flex', columnGap: 1, padding: '5px 10px', borderRadius: '8px' }}>
                    <ArrowBack />
                    Tiếp tục mua hàng
                </ButtonBase>
            </Box>
            <Box>
                <Stack direction="column" justifyContent="center" alignItems="center" spacing={1}>
                    <Paper variant="outlined" sx={{ width: '100%', display: 'flex', flexDirection: 'row' }}>
                        <InputBase placeholder="Coupon Code" sx={{ width: { xs: '100%', md: 350 }, ml: 2 }} />
