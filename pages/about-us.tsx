      ...
      <ProductLayout>
        ...
        <MainCard title={<Typography variant="h2">Giới thiệu</Typography>}>
          ...
          <Stack display="flex" direction="row" spacing={5}>
            <Grid flex={3}>
              ...
              >
                ...
                Thư&quot;, được thành lập từ năm 2020 bởi một nhóm sinh viên năm
                nhất trường Đại học Công nghệ Thông tin ĐHQG - Tp.HCM, được biết
                đến là đơn vị chuyên mua, bán các loại sách cũ trên nên tảng
                mạng xã Facebook.
              </Typography>
              <br />
              <Typography
                ...
                style={{ fontSize: matches ? 16 : 18, lineHeight: 1.5 }}
              >
                Ngày 15/09/2022, sau hơn 2 năm hoạt động với những kết quả kinh
                doanh thuận lợi, nhóm sinh viên đã dựa trên dự án &quot;Xây dựng
                Website thương mại điện tử&quot;, trưởng nhóm{' '}
          ...
          <Typography
            ...
            style={{ fontSize: matches ? 16 : 18, lineHeight: 1.5 }}
          >
            Nhóm bao gồm 7 thành viên với vị trí và nhiệm vụ khác nhau. Hợp tác
            hoạt động với phương châm tinh thần &quot;Đoàn kết - Trách nhiệm -
            Bản lĩnh&quot;.
          </Typography>
          <br />
          <Grid
          ...
          >
            ...
            <li>
              Cung cấp các giải pháp phần mềm và website thương mại điện tử cho
            ...
            <li>
              Đối tượng khách hàng: người có nhu cầu mua sách, thiết kế website.{' '}
            </li>
          </ul>
          ...
          >
            <li>
              Phạm vi dự án nằm trong nội dung đồ án môn học tại trường Đại học
              Công nghệ Thông tin ĐHQGP - Tp.HCM.
            </li>
            <li>
              Quản lý kiến thức: kiến thức thực hiện đồ án dựa trên nội dung các
              môn học: Internet Công nghệ Web, Phát triển ứng dụng Web, Thương
              mại điện tử, Quản lý dự án Công nghệ thông tin,... và các nguồn
              tài liệu tham khảo mở trên Internet.
            </li>
          </ul>
          <br />
          <Divider flexItem />
          ...
          >
            ...
            <strong>BOXO</strong> thành doanh nghiệp tốp đầu về kinh doanh, xuất
            - nhập khẩu sách. Xây dựng, phát triển ứng dụng{' '}
          ...
          >
            ...
            cấp: chất lượng, chính hãng, đảm bảo đầy đủ các quyền lợi người tiêu
            dùng với chính sách phù hợp, mang đến sự hài lòng cho khách hàng là
            mục tiêu hàng đầu của <strong>BOXO</strong>.
          </Typography>
          <br />
          <Typography
            variant="h5"
          ...
          <Typography
            ...
            style={{ fontSize: matches ? 16 : 18, lineHeight: 1.5 }}
          >
            Môi trường làm việc năng động, sáng tạo, chú trọng tinh thần sẻ chia
            giúp đỡ, đoàn kết nội bộ.
          </Typography>
          <br />
          <Typography
            variant="h5"
            style={{ fontSize: matches ? 16 : 18, lineHeight: 1.5 }}
          >
            Mang đến nguồn thu nhập ổn định, cùng nhau cống hiến tận tâm vì các
            mục tiêu chung.
          </Typography>
          <br />
